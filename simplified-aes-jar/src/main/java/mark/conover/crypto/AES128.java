...
public class AES128 {
    private static String algorithm = "AES";
     private static byte[] KEY = new byte[] { 'A', 'S', 'e', 'c', 'u',
     'r',
     'e', 'S', 'e', 'c', 'r', 'e', 't', 'K', 'e', 'y' };
...
//        System.out.println("keyValueIntArray is: " + sb.toString());
        ...
        System.out.println("Encrypted Text should be: " + generateStringFromIntArray(ciphertextShouldBe));
