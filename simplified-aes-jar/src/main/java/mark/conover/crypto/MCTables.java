 ...
 * From https://raw.githubusercontent.com/rishidewan33/Advanced-Encryption-Standard-Algorithm/master/src/MCTables.java 
 * (goes along with AES.java).
 * @author Patrick Lu
 * @author Rishi Dewan
 */
public class MCTables {
	 ...
	 * Rijndael MixColumns Wikipedia Page. Each table is used based on what a
	 * certain number is multiplied by (i.e. If some number 'a' is multiplied by
	 * 3, use the mc3 table.)
	 */
